...
function Footer() {
    return ( 
        <footer style={{backgroundColor:"rgb(255,252,252)"}}>
            <div className='container border-top mt-5'>
                <div className='row mt-5'>
                    <div className='col'>
                        <img src='media/images/logo.svg' style={{width:"60%"}}></img>
                        <p className='mt-2'>&copy; 2010 - 2024, Zerodha Broking Ltd.</p>
            ...
            <div className='container'>
                <div className='row footer' style={{fontSize:"12px"}}>
                    <div className='col'><a href="" className="text-muted"style={{textDecoration:"none"}}>NSE</a></div>
                    <div className='col'><a href="" className="text-muted"style={{textDecoration:"none"}}>BSE</a></div>
                    <div className='col'><a href="" className="text-muted"style={{textDecoration:"none"}}>MCX</a></div>
                    <div className='col'><a href="" className="text-muted"style={{textDecoration:"none"}}>Terms & conditions</a></div>
                    <div className='col'><a href="" className="text-muted"style={{textDecoration:"none"}}>Policies & procedures</a></div>
                    <div className='col'><a href="" className="text-muted"style={{textDecoration:"none"}}>Privacy policy</a></div>
                    <div className='col'><a href="" className="text-muted"style={{textDecoration:"none"}}>Disclosure</a></div>
                    <div className='col'><a href="" className="text-muted"style={{textDecoration:"none"}}>For Investor's attention</a></div>
                    <div className='col'><a href="" className="text-muted"style={{textDecoration:"none"}}>Investor charter</a></div>
                </div>
            </div>
        </footer>
     );
